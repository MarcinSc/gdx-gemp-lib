...
import com.gempukku.libgdx.lib.test.component.PhysicsComponent;
...
import com.gempukku.libgdx.lib.test.sprite.StateBasedSprite;
import com.gempukku.libgdx.lib.test.system.sensor.FootSensorData;
...
public class PlayerControlSystem extends EntitySystem {
    ...
    public void update(float delta) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.UP) && footSensorData != null && grounded) {
            playerBody.setLinearVelocity(playerBody.getLinearVelocity().x, 17);

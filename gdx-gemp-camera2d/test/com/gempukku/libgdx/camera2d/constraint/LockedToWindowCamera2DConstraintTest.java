...
public class LockedToWindowCamera2DConstraintTest extends LibGDXTest {
    ...
    public void adjustRight() {
        ...
        cameraConstraint.applyConstraint(new UpdateCameraControl(camera), new Vector2(-2, 0f), 0);
    ...
    public void adjustUp() {
        ...
        cameraConstraint.applyConstraint(new UpdateCameraControl(camera), new Vector2(0, -2f), 0);

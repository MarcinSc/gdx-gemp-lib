...
public class PickingTheEntity implements ArtemisTriggerCondition {
    ...
    public boolean isTriggered(float deltaTime, Entity entity, ObjectMap<String, Object> blackboard) {
        ...
        int alreadyPickedEntity = ((Number) blackboard.get(pickEntityId)).intValue();
        if (pickedEntity != null &&
                alreadyPickedEntity == pickedEntity.getId()) {
            return true;
        }
        return false;
    }

...
import com.gempukku.libgdx.lib.test.system.PlayerControlSystem;
import com.gempukku.libgdx.lib.test.system.RenderingSystem;
import com.gempukku.libgdx.lib.test.system.TextureHolder;
import com.gempukku.libgdx.lib.test.system.sensor.FootSensorContactListener;
import com.gempukku.libgdx.lib.test.system.sensor.InteractSensorContactListener;
...
public class LockedCameraScene implements LibgdxLibTestScene {
    ...
    public void initializeScene() {
        ...
        FacingPositionProvider positionProvider = new FacingPositionProvider() {
            @Override
